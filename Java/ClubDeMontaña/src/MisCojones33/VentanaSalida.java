...
public class VentanaSalida extends JFrame {
    ...
    public VentanaSalida(Decathlon ventana) {
        ...
        btnAgregar.addActionListener(e -> {
            ...
            dispose(); // Cerrar ventana Salida
            ventana.setVisible(true); // Mostrar ventana principal
        });
    ...
    public VentanaSalida(Decathlon padre, Salida salida) {
		 this.setTitle("Club de montaña");
			this.setVisible(true);
			this.setSize(500, 600);
	        ...
	        // Configurar acciones de los botones
	        btnAgregar.addActionListener(e -> {
	        	padre.borrarSalida(salida);
	        	String nombre = txtDia.getText();
	        	String dni = txtMes.getText();
	        	String telefono = txtHora.getText();
	        	String email = txtLugar.getText();
